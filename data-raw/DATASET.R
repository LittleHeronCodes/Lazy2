...
# 3      3       8 alpha-2-macroglobulin pseudogene 1       A2MP1
# 4     11      15     N-acetyltransferase pseudogene        NATP
# 5     12      16           serpin family A member 3    SERPINA3
# 6     13      17          arylacetamide deacetylase       AADAC
#             gene_type
